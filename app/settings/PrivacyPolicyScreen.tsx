        ...
        >
          <View>
            ...
            <ThemedText style={styles.paragraph}>
              Thank you for using{" "}
              <ThemedText style={styles.bold}>Cardy Wallet</ThemedText> (“the App”).
              Your privacy is important to us. This Privacy Policy explains how
              Cardy Wallet handles your information and ensures your personal data
              remains safe.
            </ThemedText>
            ...
            <ThemedText style={styles.paragraph}>
              Cardy Wallet does not collect, transmit, or share any personal
            ...
            <ThemedText style={styles.paragraph}>
              • All data (such as card numbers or notes) you save in Cardy Wallet is
              stored locally on your device.{"\n"}• Cardy Wallet does not automatically
            ...
            <ThemedText style={styles.paragraph}>
              • Cardy Wallet provides optional device lock authentication (PIN,
            ...
            <ThemedText style={styles.paragraph}>
              In future versions, Cardy Wallet may include non-personalized
              ...
              ads effectively.{"\n\n"}
              Cardy Wallet will never share or upload your stored data for advertising
              purposes.{"\n\n"}
            ...
            <ThemedText style={styles.paragraph}>
              Cardy Wallet is designed for general audiences and does not knowingly
            ...
            <ThemedText style={styles.paragraph}>
              By using Cardy Wallet, you acknowledge that you have read and understood
              this Privacy Policy.
            </ThemedText>
          </View>
        </ScrollView>
